...
public class DeleteLead extends UtilityFunctions {
	@Test(dependsOnMethods = "week6.day1.oops.CreateLead.leafLeadCreate")
	public void leafDeleteLead() throws InterruptedException {
