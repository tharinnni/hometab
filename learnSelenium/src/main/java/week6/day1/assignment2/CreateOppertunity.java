...
public class CreateOppertunity extends SpecifiedMethod{

	@Test(enabled = false,groups = "Oppertunity")
	public void main() throws InterruptedException {
		System.out.println("CreateOppertunity Eexcution Started");
		...
		System.out.println("CreateOppertunity Eexcution Completed");
	}
